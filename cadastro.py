...
def nova_janela():
            ...
            root1 = Tk()
            root1.title("Transações")
            root1.geometry("490x560+400+153")
...
#--------------------------------------TKINTER INTERFACE------------------------------------------------#
        ...
        Label(self.frame1,text='Cadastro do cliente',font=('Ariel','30'),bg='white').place(relx=0.30,rely=0.01)
        Label(self.frame1,text='Nome',font=('Ariel','15'),bg='white').place(relx=0.02,rely=0.12)
        self.nome=Entry(self.frame1,font=('Ariel','20'))
        self.nome.place(relx=0.02,rely=0.16)
        Label(self.frame1,text='Endereco',font=('Ariel','15'),bg='white').place(relx=0.02,rely=0.21)
        self.endereco = Entry(self.frame1,font=('Ariel','20'))
        self.endereco.place(relx=0.02,rely=0.25,relwidth=0.94)
        Label(self.frame1,text='Telefone',font=('Ariel','15'),bg='white').place(relx=0.02,rely=0.31)
        self.fone = Entry(self.frame1,font=('Ariel','20'))
        self.fone.place(relx=0.02,rely=0.36,width=200)
        Label(self.frame1,text='Complemento',font=('Ariel','15'),bg='white').place(relx=0.02,rely=0.50)
        ...
        Label(self.frame2,text='CONSULTA',font=('Ariel','30'),bg='white').place(relx=0.29,rely=0.05)
        ...
        bt_entrar = Button(root, bd=0, command=nova_janela)
...
#-----------------------------------------FUNÇÕES-----------------------------------------------------------#
    ...
    def cadastraclientes(self):
        ...
        try:
            ...
            tkinter.messagebox.showinfo(message="Esse telefone ja foi cadastrado")  
        con.commit()
